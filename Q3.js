...
console.log("Welcome to Facebook page")
login_signup=string.question("what you choose login or signup : ")
const fs=require('fs')
    ...
    if (login_signup=="signup"){
        ...
        for (i of data){
            if ((i["username"]==login_name)&&(i["password"]==login_password)){
                ...
                else if((i["username"]!=login_name)&&(i["password"]!=login_password)){
